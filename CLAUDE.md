...
This is a personal dotfiles repository for macOS, linux, and windows (coming soon?) using GNU Stow for symlink management. It provides a comprehensive development environment configuration including Zsh shell setup, terminal configurations (ghostty), and Neovim. The deployment of these files are handled by ansible in this repository

TODO: Put repository in link
...
- `codex/` - OpenAI Codex AI assistant configuration
...
- `shells` - zsh, fish, and bash configs
...
- z installed and configured by default for terminal multiplexing
